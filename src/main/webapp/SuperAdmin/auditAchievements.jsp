                            ...
                            <tr class="achievement-row"
                                ...
                                <td>
                                    <button class="btn-preview"
                                            onclick="previewAchievement(${entry.key.achievementID})">预览
                                    </button>
                                    <button class="btn-pass"
                                            onclick="passAchievementReview(${entry.key.achievementID})">通过
                                    </button>
                                    <button class="btn-reject"
                                            onclick="rejectAchievementReview(${entry.key.achievementID})">拒绝
                                    </button>
                                </td>
                            </tr>
                        </c:if>
